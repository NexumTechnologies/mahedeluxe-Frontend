  ...
  return (
    <section className="pb-14 sm:pb-18 lg:pb-24">
      <div className="mx-auto w-full max-w-350 px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[2rem] bg-[#1fb65f] px-6 py-8 text-white shadow-[0_24px_80px_rgba(20,98,58,0.22)] sm:px-10 sm:py-12 lg:px-12 lg:py-14">
          ...
          <div className="absolute right-[-8rem] top-1/2 h-72 w-72 -translate-y-1/2 rounded-full bg-[#8bd15f]/35 blur-[2px]" />
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1.25fr_0.8fr_0.8fr]">
            <div className="max-w-xl space-y-5">
              ...
              <div className="space-y-3">
                ...
                <p className="max-w-md text-lg text-white/85 sm:text-2xl">
                  Earn money. Save.
                  <br />
              ...
              <Link
                href="#"
                className="inline-flex min-w-[270px] items-center gap-4 rounded-2xl bg-[#178a48] px-6 py-4 shadow-[0_12px_32px_rgba(0,0,0,0.16)] transition hover:bg-[#13763d]"
              >
                <Image src="/apple.svg" alt="App Store" width={38} height={46} className="h-11 w-11" />
                <span className="text-left">
                  <span className="block text-xs font-medium text-white/75">Download on the</span>
