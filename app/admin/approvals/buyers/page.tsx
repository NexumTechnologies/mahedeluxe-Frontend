  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-gray-900">Buyer Approvals</h1>
          <p className="text-sm text-gray-500 mt-1">Review and approve buyers that are not yet verified.</p>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
        {isLoading ? (
          ...
          <div className="p-6 text-center text-sm text-red-600">Failed to load buyer approvals</div>
        ) : (
          <>
            ...
            <div className="p-4 bg-gray-50/60">
              {users.length === 0 ? (
                <div className="py-8 text-center text-sm text-gray-500">No buyers waiting for approval.</div>
              ) : (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="mt-1 text-xs text-gray-500">Registered buyer awaiting verification.</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3 sm:gap-4">
                        ...
                        >
                          ...
                          {approveMutation.isPending && pendingUserId === b.id ? "Approving..." : "Approve"}
                        </button>
                      </div>
                    </li>
                  ))}
